...
export default {
  ...
  methods: {
    ...
    updateChart(universityData) {
      ...
      const defaultData = [
        { name: '计算机科学与技术', value: 204, description: '计算机科学与技术是一门普通高等学校本科专业，是计算机类专业的基础专业之一。该专业主要研究计算机的理论、算法、数据结构、操作系统等方面的知识，培养学生具备扎实的计算机基础理论和实践能力，能够从事计算机系统的设计、开发、维护和管理等工作。' },
        { name: '软件工程', value: 68, description: '软件工程是一门研究用工程化方法构建和维护有效的、实用的和高质量的软件的学科。该专业注重培养学生的软件开发能力，包括软件需求分析、设计、编码、测试和维护等方面的技能，使学生能够运用工程化的方法和工具进行软件项目的开发和管理。' },
        { name: '电子信息', value: 699, description: '电子信息工程专业主要研究电子电路、信号处理、通信原理、计算机技术等方面的知识，培养学生具备电子信息系统的设计、开发、测试和维护等能力，能够在电子信息领域从事相关工作。' },
        { name: '网络空间安全', value: 103, description: '网络空间安全专业致力于培养能够应对网络安全挑战的专业人才。该专业涉及网络安全技术、信息安全管理、密码学等方面的知识，使学生掌握网络空间安全的核心技术和方法，能够进行网络安全防护、安全评估和应急响应等工作。' },
        { name: '智能科学与技术', value: 25, description: '智能科学与技术专业融合了计算机科学、人工智能、控制科学等多学科知识，旨在培养具备智能系统设计、开发和应用能力的专业人才。该专业注重培养学生在智能算法、机器人技术、智能控制等方面的技能。' }
      ];
      // 调试数据
      console.log('Updating word cloud with universityData:', universityData);
      const option = {
        tooltip: {
          show: true,
          trigger: 'item',
        ...
        series: [{
          ...
          data: defaultData.map(item => ({
            ...item,
            value: universityData[item.name] || 50 // 设置最小值确保显示
          })),
          sizeRange: [16, 35], // 调整字体范围
          gridSize: 5, // 增加间距
          rotationRange: [0, 0],
          shape: 'square', // 使用方形布局
          width: '100%',
