<template>
  <div ref="wordcloudChart" style="width:100%; height: 200px;"></div>
</template>
    ...
    initChart() {
      ...
      const option = {
        tooltip: {
                  ...
                  extraCssText: 'box-shadow: 0 0 5px rgba(0, 0, 0, 0.3); white-space: normal; width: 400px;'
              },
        series: [{
          type: 'wordCloud',
          data: [
          ...
          sizeRange: [16, 46], // 文字大小范围
          rotationRange: [0, 0], // 旋转角度范围
          shape: 'circle', // 词云形状（可选：cardioid, diamond, triangle等）
          textStyle: {
          color: (params) => {
            // 按数据索引循环取色
